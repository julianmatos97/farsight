...
class DocumentSelector:
    ...
    def select_documents(self, query_analysis: QueryAnalysis) -> List[DocumentReference]:
        ...
        """
        logger.info(f"Selecting documents for query: {query_analysis}")
        ...
        for company in companies:
            ...
            company_documents = self.document_registry[company]
            
            # Filter by year and quarter
            for year in years:
                # Find 10-K for this year
                annual_docs = [
                    doc for doc in company_documents 
                ...
                if quarters:
                    for quarter in quarters:
                        ...
                        quarterly_docs = [
                            doc for doc in company_documents 
                            if doc.year == year and doc.filing_type == "10-Q" and doc.quarter == quarter
                        ]
