    ...
    try:
        ...
        with patch.object(client, "_format_cik", return_value="0000000000"):
            with patch.object(
                client,
                "_find_filing_url",
                return_value="https://example.com/filing.html",
            ):
...
@patch(
    "farsight2.document_processing.document_processor.DocumentProcessor._extract_text_chunks"
)
@patch(
    "farsight2.document_processing.document_processor.DocumentProcessor._extract_tables"
)
@patch(
    "farsight2.document_processing.document_processor.DocumentProcessor._extract_charts"
)
        ...
        with patch.object(
            ...
            with patch.object(
                ...
                with patch.object(
                    ...
                    "_parse_document",
                    return_value=MagicMock(
                        document_id="DOC123", text_chunks=[], tables=[], charts=[]
                    ),
                ):
